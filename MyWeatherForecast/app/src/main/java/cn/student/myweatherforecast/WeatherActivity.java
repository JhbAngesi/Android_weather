package cn.student.myweatherforecast;
...
import cn.student.myweatherforecast.gson.Weather;
import cn.student.myweatherforecast.service.AutoUpdateService;
import okhttp3.Call;
import okhttp3.Callback;
import okhttp3.Response;

import cn.student.myweatherforecast.util.HttpUtil;
import cn.student.myweatherforecast.util.Utility;

import static cn.student.myweatherforecast.MyDBhelper.DB_NAME;
import static cn.student.myweatherforecast.MyDBhelper.TABLE_NAME;
    ...
    private void loadBingPic() {
        ...
        HttpUtil.sendOkHttpRequest(requestBingPic, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                SharedPreferences.Editor editor = getSharedPreferences(String.valueOf(WeatherActivity.this),MODE_PRIVATE).edit();
